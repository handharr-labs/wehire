...
Tracked issues for **WeHire**. Each row links to the local issue file.
...
| 007 | Implement subdomain routing middleware for branded career pages | `open` | [007-subdomain-routing-middleware.md](./007-subdomain-routing-middleware.md) |
| 008 | Enforce plan job limit and surface 'not hiring' state on career page | `open` | [008-plan-limit-management.md](./008-plan-limit-management.md) |
| 009 | Build WeHire marketing landing page | `open` | [009-wehire-landing-page.md](./009-wehire-landing-page.md) |
| 010 | Document environment variable setup and create .env.example | `open` | [010-env-variable-setup-docs.md](./010-env-variable-setup-docs.md) |
